...
const eggs_routes_1 = require("./eggs.routes");
...
let EggsModule = class EggsModule {
};
EggsModule = __decorate([
    core_1.NgModule({
        imports: [
            common_1.CommonModule,
            forms_1.FormsModule,
            filter_module_1.PipeModule.forRoot(),
            router_1.RouterModule.forChild(eggs_routes_1.EggsRoutes),
        ],
        declarations: [
            eggs_component_1.EggsComponent,
...
exports.EggsModule = EggsModule;
//# sourceMappingURL=eggs.module.js.map